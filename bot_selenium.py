...
while len(webdrive.find_elements(By.NAME, 'psRNGCDefaultType')) < 1:
    sleep(1)

login = webdrive.find_element(By.ID, 'i0116') # procurar pelo ID para preencher o login
login.send_keys("sergio.lima53@etec.sp.gov.br") # escreve no login
sleep(2)
...
senha.send_keys("papagaio12@") # escreve na senha
sleep(5)
